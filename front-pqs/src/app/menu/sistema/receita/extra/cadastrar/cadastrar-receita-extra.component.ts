...
@Component({
  selector: 'app-cadastrar-receita-extra',
  templateUrl: './cadastrar-receita-extra.component.html',
  styleUrls: ['./cadastrar-receita-extra.component.css']
})
export class CadastrarReceitaExtraComponent implements OnInit {
