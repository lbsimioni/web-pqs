...
@Component({
  selector: 'app-consultar-despesa-extra',
  templateUrl: './consultar-despesa-extra.component.html',
  styleUrls: ['./consultar-despesa-extra.component.css']
})
export class ConsultarDespesaExtraComponent implements OnInit {

    private lstDespesas: any[];

    private editarRota: string = '/menu/despesa/extra/editar';
